...
class HomeController extends BaseController {
  ...
  Future<Menu> getMenuData({String per_page="10",required String city_id,required String filter, required String page, String? category_id="", String? clinic_id="", String? q=""}) async {
   ...
   Future<Diary> getDiaryData({required String city_id, String per_page="10", required String page, String? category_id="", String? clinic_id="", String? patient_id="", String? favorote="", String? orderby="", String? menu_id="", String? price_min="", String? price_max="", String? rate="", String? q="",required String filter,required String year}) async {
