          ...
          children: <Widget>[
            Row(
              children: [
                ...
                Expanded(flex:6,child: Center(child: Text(Trans.of(context).member_regirtration,style: defaultTextStyle(Colors.black, FontWeight.w500,size:20) ))),
            ...
            Align(
              ...
              }, child:Text(Trans.of(context).required_password,style:TextStyle(color:Color.fromARGB(250, 102, 110, 110),fontWeight:FontWeight.bold,fontSize: 12),)
              ),
            ),
            Padding(
