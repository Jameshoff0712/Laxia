...
import 'package:laxia/screens/auth/password_reset/passrest_four.dart';
          ...
          children: <Widget>[
            Row(
              children: [
                ...
                Expanded(flex:6,child: Center(child: Text(Trans.of(context).reset_password_res,style: defaultTextStyle(Colors.black, FontWeight.w700,size:16) ))),
                Expanded(flex:2,child: SizedBox(width: double.infinity,)),
              ],
            ),    
            const SizedBox(height: 28,),
            Align(alignment: Alignment.centerLeft, child: Text( Trans.of(context).input_new_password,style:TextStyle(color:Color.fromARGB(250, 102, 110, 110),fontWeight:FontWeight.w400,fontSize: 14))),
            ...
            Padding(
              ...
              child: Align( alignment: Alignment.centerLeft, child: Text(Trans.of(context).required_password,style: defaultTextStyle(Color.fromARGB(255,51, 51, 51), FontWeight.w400,size:12))),
            ),
            SizedBox(height: 50),
            Padding(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => PassRest_Four()));
                },
              ),
            ),
          ],
