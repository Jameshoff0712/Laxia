  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child:Column(
          children: <Widget>[
             Center(child: SvgPicture.asset("images/check_mail.svg",width: 54.17,height: 54.17,)),
             SizedBox(height: 30.83,),
             Center(child: Text(Trans.of(context).complete_reset,style: defaultTextStyle(Color.fromARGB(255,110, 198, 210), FontWeight.w700,size:18))),
             SizedBox(height: 20,),
             Center(child: Text(Trans.of(context).reset_password_end,style: defaultTextStyle(Color.fromARGB(255,156, 161, 161), FontWeight.w700,size:14))),
             Padding(
