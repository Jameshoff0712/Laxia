...
class _ToggleSwitchButtonState extends State<ToggleSwitchButton> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(ToggleSwitchButton oldWidget) {
    ...
    return GestureDetector(
      ...
      child: Opacity(
        ...
        child: AnimatedBuilder(
          ...
          child: Stack(
            children: [
              widget.activeImage != null || widget.inactiveImage != null ? _buildBackgroundImage() : SizedBox.shrink(),
              AnimatedBuilder(
                animation: _animationController,
