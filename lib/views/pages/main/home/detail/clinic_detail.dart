...
class Clinic_Datail extends StatefulWidget {
  const Clinic_Datail({Key? key}) : super(key: key);

  @override
  State<Clinic_Datail> createState() => _Clinic_DatailState();
}

class _Clinic_DatailState extends State<Clinic_Datail> {
   List clinic_Details = [];
                ...
                children: [
                  Column(
                    children: [
                      ...
                      Clinic_Card(
                          image: "none",
                          clinic:clinic_Details[0]["clinic"],
                  ...
                  child: Container(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Doctor_Group_Card(doctor: clinic_Details[0]["doctors"][index],);
                      }),
                  ),
                ),
              ]),
                    ...
                    child: Column(
                      children: [
                        ...
                        ListView.builder(
                            ...
                            itemCount: clinic_Details[0]["diarys"].length,
                            physics:NeverScrollableScrollPhysics(),
                            shrinkWrap:true,
                            itemBuilder: (BuildContext context, int index) {
                              return Diary_Card(
