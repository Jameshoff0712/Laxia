            ...
            child: Stack(
              ...
              children: [
                ...
                child:SizedBox(
                  ...
                  child: InkWell(
                    child: Container(
                      decoration: BoxDecoration(color: Helper.mainColor,
          ...
          Padding(
            ...
            child: Row(
              children: [
                Expanded(
                  flex: 9,
                  child: Text("東京都新宿区西新宿６丁目５−１ 新宿アイランドタワ 24F",softWrap: true,style: TextStyle(fontSize: 16,fontWeight: FontWeight.w400,color: Helper.maintxtColor),)),
                Expanded(
                  flex: 1,
