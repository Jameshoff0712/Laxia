...
class _Doctor_DetailState extends State<Doctor_Detail> {
  ...
  Widget build(BuildContext context) {
    ...
    return doctor_Details.isNotEmpty
        ? Scaffold(
                        ...
                        InkWell(
                          onTap: () {
                            Navigator.of(context).push(
                              ...
                              for (int j = 0; j < doctor_Details[0]["images"].length; j++)
                                doctor_Details[0]["images"][j]
                            ],
                            startindex: 1,)));
                          },
                          child: Detail_Image(
                            ...
                            insidestar: true,
                            height: 375,
                            imageList: doctor_Details[0]["images"], onPressUpRight: () {  }, onPressBack: () {
                                ...
                                onTap: () {
                                  Navigator.of(context).push(MaterialPageRoute(
                                      builder: (_) => Doctor_Sub_Detail(
                                            doctor_detail: doctor_Details[0],
                                            index: 1,
                                          )));
                                },
                                child: Row(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return Diary_Card(
                                  avator: doctor_Details[0]['diarys'][index]
                                      ["avator"],
                                  check: doctor_Details[0]['diarys'][index]
                                      ["check"],
                                  image2: doctor_Details[0]['diarys'][index]
                                      ["image2"],
                                  image1: doctor_Details[0]['diarys'][index]
                                      ["image1"],
                                  eyes: doctor_Details[0]['diarys'][index]
                                      ["eyes"],
                                  clinic: doctor_Details[0]['diarys'][index]
                                      ["clinic"],
                                  name: doctor_Details[0]['diarys'][index]
                                      ["name"],
                                  onpress: () {},
                                  price: doctor_Details[0]['diarys'][index]
                                      ["price"],
                                  sentence: doctor_Details[0]['diarys'][index]
                                      ["sentence"],
                                  type: doctor_Details[0]['diarys'][index]
                                      ["type"]);
                            }),
                        Padding(
                          padding: EdgeInsets.symmetric(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return Question_Card(
                                ...
                                hearts: doctor_Details[0]['questions'][index]
                                    ["hearts"],
                                chats: doctor_Details[0]['questions'][index]
                                    ["chats"],
                                ...
                                image1: doctor_Details[0]['questions'][index]
                                    ["image1"],
                                eyes: doctor_Details[0]['questions'][index]
                                    ["eyes"],
                                name: doctor_Details[0]['questions'][index]
                                    ["name"],
                                onpress: () {},
                                sentence: doctor_Details[0]['questions'][index]
                                    ["sentence"],
                                type: doctor_Details[0]['questions'][index]
                                    ["type"],
                              );
                              ;
                            }),
