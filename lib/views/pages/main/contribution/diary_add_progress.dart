  ...
  Widget build(BuildContext context) {
    ...
    if (initDetail &&
      ...
      diaryProperties.numbers_date =
          progressDetail.progress.from_treat_day.toString();
      setState(() {
        imageIds = [];
        images = [];
                              ...
                              Expanded(
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      diaryProperties.numbers_date != ''
                                          ? diaryProperties.numbers_date + '日目'
                                          : "選択してください",
                                      overflow: TextOverflow.ellipsis,
                                      style: TextStyle(
                                          color:
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              onPressed: isAddEnabled
                                  ? () async {
                                      ProgressPostModel newProgress =
                                          new ProgressPostModel(
                                              from_treat_day:
                                                  diaryProperties.numbers_date,
                                              ...
                                              status3: status3,
                                              imageIds: imageIds);
                                      final result = await _conMy.postProgress(
                                          newProgress, widget.diary_id);
                                      print(result.data);
                          ...
                          child: ElevatedButton(
                            onPressed: isAddEnabled
                                ? () async {
                                    ...
                                    final result = await _conMy.editProgress(
                                        newProgress, widget.progress_id!);
                                    print(result.data);
