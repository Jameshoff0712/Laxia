                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return DiaryAddPage_Card(
                            ...
                            fontcolor: (diary_list[index].status == "未公開" ? Color.fromARGB(255, 102, 110, 110) : Color.fromARGB(255, 240, 154, 55)),
                            buttoncolor: (diary_list[index].status == "未公開" ? Color.fromARGB(50, 102, 110, 110) : Color.fromARGB(50, 240, 154, 55)),
                          );
                        }),
                  ),
                ],
