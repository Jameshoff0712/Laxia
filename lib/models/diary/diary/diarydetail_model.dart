...
>>>>>>> a20c9d9c06b468c1a2810e38da7de5bfadc531dd
          as Iterable<dynamic>),
      text_questions: json["text_questions"] == null
          ? []
          : List<Test_Question>.from(json["text_questions"]
                  .map((x) => Test_Question.fromJson(x as Map<String, dynamic>))
              as Iterable<dynamic>),
      medias: json["medias"] == null
          ? []
          : List<Media_model>.from(json["medias"]
                  .map((x) => Media_model.fromJson(x as Map<String, dynamic>))
              as Iterable<dynamic>),
      beforemedias: json["beforemedias"] == null
          ? []
          : List<Media_model>.from(json["beforemedias"]
                  .map((x) => Media_model.fromJson(x as Map<String, dynamic>))
              as Iterable<dynamic>),
      aftermedias: json["aftermedias"] == null
          ? []
          : List<Media_model>.from(json["aftermedias"]
                  .map((x) => Media_model.fromJson(x as Map<String, dynamic>))
              as Iterable<dynamic>),
      diaries: json["menus"][0][["diaries"]] == null
          ? []
          : List<Diary_Sub_Model>.from(json["menus"][0][["diaries"]].map(
                  (x) => Diary_Sub_Model.fromJson(x as Map<String, dynamic>))
              as Iterable<dynamic>),
      progresses: json["progresses"] == null
          ? []
          : List<Progress>.from(json["progresses"]
                  .map((x) => Progress.fromJson(x as Map<String, dynamic>))
              as Iterable<dynamic>),
