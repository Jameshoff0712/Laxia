...
class Question extends Equatable {
  ...
  final List<Question_Sub_Model> data;
  ...
  factory Question.fromJson(Map<String, dynamic> json) {
    return Question(
        ...
        data: List<Question_Sub_Model>.from(json["data"].map((x) => Question_Sub_Model.fromJson(x as Map<String, dynamic>)) as Iterable<dynamic>) ,
